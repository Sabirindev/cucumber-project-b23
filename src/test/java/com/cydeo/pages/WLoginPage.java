...
//represents webOrder login page
public class WLoginPage {
    ...
    //when this constructoris called
    ...
    /**
     * Lofin with parameters
     * @param username username
     * @param password password
     */

    public void login(String username, String password) {
        //you can access directly using userNameFiled or this.userNameField
     ...
     * loginErrorMsgPresent simple return the result of isDisplayed metthod call
     */
